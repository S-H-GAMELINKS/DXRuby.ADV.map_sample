...
ap1 = Sprite.new(120, 80, Image.load("ap.png")); ap2 = Sprite.new(40, 180, Image.load("ap.png"))
ap3 = Sprite.new(160, 170, Image.load("ap.png")); ap4 = Sprite.new(220, 230, Image.load("ap.png"))
ap5 = Sprite.new(200, 380, Image.load("ap.png")); ap6 = Sprite.new(350, 300, Image.load("ap.png"))
...
#フォントサイズ
map_font = Font.new(32); font = Font.new(26)
...
Window.loop do
	...
	#地名(アクセスポイント)の◆描画
	ap1.draw; ap2.draw; ap3.draw; ap4.draw; ap5.draw; ap6.draw
